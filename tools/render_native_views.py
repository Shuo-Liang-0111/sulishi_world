...
if version in ['G1_027r8','G1_027r9']:
...
try:
    ...
    for index,camera in enumerate(args):
        ...
        completed.append({'camera':camera,'file':str(path.relative_to(root)),**verified,
                          'sternen_door_open_fraction':float(bpy.data.objects['SG_R8_RESTAURANT_DOOR_CONTROL']['open_fraction']) if version in ['G1_027r8','G1_027r9'] else None})
