...
if s['version'].startswith('G1_027'):
    ...
    if s['version'] in ['G1_027r2','G1_027r3','G1_027r4','G1_027r5','G1_027r6','G1_027r7','G1_027r8','G1_027r9','G1_027r10','G1_027r11','G1_027r12','G1_027r13','G1_027r14','G1_027r15']:
    ...
    if s['version'] in ['G1_027r5','G1_027r6','G1_027r7','G1_027r8','G1_027r9','G1_027r10','G1_027r11','G1_027r12','G1_027r13','G1_027r14','G1_027r15']:
        runpy.run_path(str(R/'tools/blender_check_sternen_grill.py'))
    if s['version'] in ['G1_027r8','G1_027r9','G1_027r10','G1_027r11','G1_027r12','G1_027r13','G1_027r14','G1_027r15']:
        runpy.run_path(str(R/'tools/blender_check_sternen_doors.py'),run_name='__main__')
    if s['version'] in ['G1_027r9','G1_027r10','G1_027r11','G1_027r12','G1_027r13','G1_027r14','G1_027r15']:
        runpy.run_path(str(R/'tools/blender_check_ubs_frontages.py'),run_name='__main__')
    if s['version'] in ['G1_027r10','G1_027r11','G1_027r12','G1_027r13','G1_027r14','G1_027r15']:
    ...
    if s['version'] in ['G1_027r11','G1_027r12','G1_027r13','G1_027r14','G1_027r15']:
        runpy.run_path(str(R/'tools/blender_check_stadelhofen_01.py'),run_name='__main__')
    if s['version'] in ['G1_027r12','G1_027r13','G1_027r14','G1_027r15']:
        runpy.run_path(str(R/'tools/blender_check_bank_tram_shelter.py'),run_name='__main__')
    if s['version']=='G1_027r15':
        runpy.run_path(str(R/'tools/blender_check_ubs_upper_residuals.py'),run_name='__main__')
