...
s=bpy.context.scene
assert s['version'].startswith(('G1_015','G1_016','G1_017','G1_018','G1_019','G1_020','G1_021','G1_022'))
...
if s['version'].startswith(('G1_020','G1_021','G1_022')):
    import runpy
    runpy.run_path(str(R/'tools/blender_check_utoquai_kiosk.py'))
if s['version'].startswith(('G1_021','G1_022')):
...
if s['version'].startswith('G1_022'):
    runpy.run_path(str(R/'tools/blender_check_riviera_lower.py'))
if s['version'].startswith(('G1_019','G1_020','G1_021','G1_022')):
