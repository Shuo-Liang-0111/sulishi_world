...
if s['version'].startswith('G1_027'):
    ...
    if s['version'] in ['G1_027r2','G1_027r3','G1_027r4','G1_027r5','G1_027r6','G1_027r7','G1_027r8']:
    ...
    if s['version'] in ['G1_027r5','G1_027r6','G1_027r7','G1_027r8']:
        runpy.run_path(str(R/'tools/blender_check_sternen_grill.py'))
    if s['version']=='G1_027r8':
