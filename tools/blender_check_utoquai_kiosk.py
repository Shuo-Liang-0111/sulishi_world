...
assert scene['version'].startswith(('G1_020','G1_021','G1_022','G1_023','G1_024'))
...
if scene['version'] in ['G1_020r1','G1_020r2','G1_020r3','G1_020r4'] or scene['version'].startswith(('G1_021','G1_022','G1_023','G1_024')):
    seams=[]
