...
assert str(scene['version']).startswith(('G1_005','G1_006','G1_007','G1_008','G1_009','G1_010','G1_011','G1_012','G1_013','G1_014','G1_015','G1_016','G1_017','G1_018','G1_019','G1_020','G1_021','G1_022','G1_023','G1_024','G1_025','G1_026','G1_027'))
...
with (read_path(ROOT/'web/assets/G1_004r2_photo_stream.glb')).open('rb') as file:
...
try:
    for distance,mat,record in candidates:
        ...
        image=bpy.data.images.load(str(read_path(ROOT/'web/assets'/record[tier])),check_existing=True)
