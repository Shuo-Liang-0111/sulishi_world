...
作者和完整渲染须串行。作者33644、失败的首轮渲染34940均已退出；修复后的独立渲染10436退出0，记录在runtime/logs/blender-20260925_231449_549.exit.json。当前无运行中的Blender。下一次用tools/start_blender.ps1默认打开H中027r3；长调用先查最终文件和进程，不重复提交。
