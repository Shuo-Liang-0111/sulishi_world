...
## 当前可接续施工稿：r14，银行侧站棚局部建模通过

H/native/G1_027r14_bank_tram_curvature.blend，107,717,872字节、18,648对象，SHA256 438b8498fce98051e0ee98edc85403454b1943480d18ed972b9b7ca0c1a35c8a。workspace.local.json已指向此稿。r11/r12/r13保留：r12扫描遮挡与木纹不通过，r13近残片修好但底棚明暗折面不通过；r14修复实际未连接顶点与曲率采样，真实屋面轮廓、平台、设施锚点、旧相机及SF1保持。
...
主线退回把所有面压到14.9°就通过的方案：15°是摄影候选过滤角，不能当真实步行面设计目标。协作线需查明陡面位置/可见面积/纵横坡与真实源面、SF1接口关系，必要时提出最小接口修订。方案未审查前不能执行v04建造，更不派第三区域。资源仍按runtime/coordination/blender_lease.json和实际进程明确交接。

## r11保留历史：并行首块已独立接收

H/native/G1_027r11_stadelhofen_entry_integrated.blend，102,854,122字节、18,546对象，SHA256为90df6b61e3dc1beef7d0a33abf9365a98dcf7af35eafd06209ebd46bf30f74db。此稿曾作为工作基底，当前指针已提升r14。仅接收Stadelhofen旧站房中央入口这块施工增量，不代表完整站区、室内或G1验收。
